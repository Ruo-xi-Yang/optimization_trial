...
def cirrus_jobfile(n,idvpath,GPUs,wctime,i,x,y,AoA,p_ini_file,main_ini_file,second_ini_file,p_sol_file,t,optimisation):
    ...
    s.write('mpiexec -n 3 pyfr -p run -b cuda '+str(AoA)+ 'AoA-gen-'+str(n)+'-idv-'+str(i)+'.pyfrm '+main_ini_file+'\n')
    s.write('mpiexec -n 3 pyfr -p run -b cuda '+str(AoA)+ 'AoA-gen-'+str(n)+'-idv-'+str(i)+'.pyfrm '+second_ini_file+'\n')
...
def eval_file(n,i,idvpath,optimisation,AoA,GPUs):
    ...
    f.write('/home/ruoxi/PyFR-15/pyfrv15/bin/pyfr partition 3 ' + str(AoA) +'AoA-gen-' + str(n) + '-idv-' + str(i) + '.pyfrm ' + '%s\n' % idvpath)
